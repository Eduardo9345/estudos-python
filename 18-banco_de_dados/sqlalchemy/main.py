...
#Create
# usuario = Usuario("Eduardo", "qualquercoisa@gmail.com", "123123")
# session.add(usuario) # adiciona a instância na sessão
# session.commit() # salva as alterações

# usuario = Usuario("Eduardo", "qualquercoisa2@gmail.com", "123123")
# session.add(usuario) # adiciona a instância na sessão
# session.commit() # salva as alterações


# livro = Livro("A culpa é das estrelas", 200, dono = usuario_lira.id)
# session.add(livro)
# session.commit()

#Read
# lista_usuarios = session.query(Usuario).all() # Query na tabela usuarios
# usuario_lira = session.query(Usuario).filter_by(email = "qualquercoisa@gmail.com").first() #ou .all()
...
#Delete
# usuario_lira_2 = session.query(Usuario).filter_by(email = "qualquercoisa2@gmail.com").first() #ou .all()
# session.delete(usuario_lira_2)
# session.commit()