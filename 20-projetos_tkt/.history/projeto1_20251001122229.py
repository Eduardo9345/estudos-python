...
def calculate_age():
    ...
    calculo = relativedelta(initial_date, birth_date)
    
    years = calculo.years
    months = calculo.months
    days = calculo.days
...
b_calculate_age = Button(bottom_frame, text="Calcular idade", width=20, height=1,
                         bg=color1, fg= color3, font = ("Ivy 10 bold"), relief=RAISED, overrelief=RIDGE, command=calculate_age)
