...
# Labels Top Frame====================================================================================
app_calculator = Label(top_frame, text="Calcula de", width=25, height=1, padx=3,
...
app_years.place(x=50, y=135)

app_label_years = Label(bottom_frame, text="Ano(s)", height=1, padx=0,
...
app_months = Label(bottom_frame, text="27", height=1, padx=0,
                       relief="flat", anchor="center", font = ("Ivy 25 bold"), bg=color1, fg=color3)
app_months.place(x=130, y=135)

app_label_months = Label(bottom_frame, text="Mes(es)", height=1, padx=0,
                       relief="flat", anchor="center", font = ("Ivy 11 bold"), bg=color1, fg=color3)
...
app_label_days = Label(bottom_frame, text="Dia(s)", height=1, padx=0,
                       relief="flat", anchor="center", font = ("Ivy 11 bold"), bg=color1, fg=color3)
...
def calculate_age():
    ...
    resultado_calculo = relativedelta(initial_date, birth_date)
    
    years = resultado_calculo.years
    months = resultado_calculo.months
    days = resultado_calculo.days
